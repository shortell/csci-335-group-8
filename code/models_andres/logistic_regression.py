...
fig.suptitle("Logistic Regression — Classification Results", fontsize=15, fontweight="bold")
...
plt.tight_layout()
plt.savefig("lr_classification.png", dpi=150)
plt.show()
print("Saved: lr_classification.png")

# REGRESSION PLOTS
fig, axes = plt.subplots(1, 3, figsize=(16, 5))
fig.suptitle("Ridge Regression — Regression Results", fontsize=15, fontweight="bold")
...
plt.tight_layout()
plt.savefig("lr_regression.png", dpi=150)
plt.show()
print("Saved: lr_regression.png")