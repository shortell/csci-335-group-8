...
cls_model = MLPClassifier(
    ...
    max_iter=300,
    early_stopping=False,   # disabled — string labels cause TypeError in some sklearn versions
    random_state=42
)
...
print("=" * 50)
print("Neural Network — Regression (Val)")
print("=" * 50)
...
print(f"  R²:   {r2_score(y_val_reg, val_reg_preds):.4f}")

print("\n" + "=" * 50)
print("Neural Network — Regression (Test)")
print("=" * 50)
...
print(f"  R²:   {r2_score(y_test_reg, test_reg_preds):.4f}")
...
fig.suptitle("Neural Network — Classification Results", fontsize=15, fontweight="bold")
...
plt.show()
print("Saved: nn_classification.png")

# REGRESSION PLOTS
fig, axes = plt.subplots(1, 3, figsize=(16, 5))
fig.suptitle("Neural Network — Regression Results", fontsize=15, fontweight="bold")
