...
report_content = "Multi-Layer Perceptron (MLP) Models Report (Tuning)\n"
report_content += "===================================================\n\n"
...
param_grid = {
    'hidden_layer_sizes': [
        (11, 8), (8, 5),              # 2 layers
        (11, 8, 5), (8, 6, 4),        # 3 layers
        (11, 8, 6, 4), (11, 11, 11, 11) # 4 layers
    ],
...
for i in range(len(sampler)):
    thresh_down, thresh_up = random.choice(thresholds_list)
    params = sampler[i]
